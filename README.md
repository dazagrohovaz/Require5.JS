Require5.JS is almost like NodeJS style require-Function for the browser
...
Features:
  ...
  - cross-domain requests, don't support data storage or other features,
    just push the scripts into document.head
